...
#include "autocar_msgs/msg/detail/slip_condition__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autocar_msgs::msg::SlipCondition & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autocar_msgs::msg::SlipCondition & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_autocar_msgs
max_serialized_size_SlipCondition(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autocar_msgs::msg::SlipCondition;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autocar_msgs::msg::SlipCondition *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autocar_msgs::msg::SlipCondition *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SlipCondition__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const autocar_msgs::msg::SlipCondition *>(
...
static size_t _SlipCondition__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SlipCondition(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SlipCondition__callbacks = {
  "autocar_msgs::msg",
  "SlipCondition",
...
static rosidl_message_type_support_t _SlipCondition__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SlipCondition__callbacks,
...
{
  return &autocar_msgs::msg::typesupport_fastrtps_cpp::_SlipCondition__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autocar_msgs, msg, SlipCondition)() {
  return &autocar_msgs::msg::typesupport_fastrtps_cpp::_SlipCondition__handle;
}
