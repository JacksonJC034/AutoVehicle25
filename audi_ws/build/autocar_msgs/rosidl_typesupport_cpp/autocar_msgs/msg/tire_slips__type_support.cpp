...
static const _TireSlips_type_support_symbol_names_t _TireSlips_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autocar_msgs, msg, TireSlips)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autocar_msgs, msg, TireSlips)),
  }
};
...
{
  return &::autocar_msgs::msg::rosidl_typesupport_cpp::TireSlips_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, autocar_msgs, msg, TireSlips)() {
  return get_message_type_support_handle<autocar_msgs::msg::TireSlips>();
}
