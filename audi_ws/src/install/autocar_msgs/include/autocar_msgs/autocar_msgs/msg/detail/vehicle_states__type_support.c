...
static rosidl_typesupport_introspection_c__MessageMember autocar_msgs__msg__VehicleStates__rosidl_typesupport_introspection_c__VehicleStates_message_member_array[1] = {
  {
    ...
    offsetof(autocar_msgs__msg__VehicleStates, structure_needs_at_least_one_member),  // bytes offset in struct
    NULL,  // default value
