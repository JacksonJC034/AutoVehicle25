...
static const _VehicleStates_type_support_symbol_names_t _VehicleStates_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autocar_msgs, msg, VehicleStates)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autocar_msgs, msg, VehicleStates)),
  }
};
...
{
  return &::autocar_msgs::msg::rosidl_typesupport_cpp::VehicleStates_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, autocar_msgs, msg, VehicleStates)() {
  return get_message_type_support_handle<autocar_msgs::msg::VehicleStates>();
}
