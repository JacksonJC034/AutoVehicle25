  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autocar_msgs::msg::State2D;
    is_plain =
      (
...
static size_t _State2D__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_State2D(full_bounded, is_plain, 0);
